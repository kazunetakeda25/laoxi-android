...
public class GenericPostMultipartAsync extends AsyncTask<Void, Void, Response> {
    ...
    public GenericPostMultipartAsync( HashMap<String, String> param, @Nullable String fileParamName, @Nullable String path,
    ...
    protected Response doInBackground(Void... params) {
        ...
        if (path != null) {
            ...
            multipartBody.addFormDataPart("profile_image", file.getName(),RequestBody.create(MEDIA_TYPE_PNG, file));
        }
