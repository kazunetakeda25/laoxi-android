...
public class RecyclerItemClickSupport {
    ...
    private RecyclerItemClickSupport(RecyclerView recyclerView) {
        ...
        mRecyclerView.setTag(R.id.item_touch_helper_previous_elevation, this);
        mRecyclerView.addOnChildAttachStateChangeListener(mAttachListener);
    }

    public static RecyclerItemClickSupport addTo(RecyclerView view) {
        RecyclerItemClickSupport support = (RecyclerItemClickSupport) view.getTag(R.id.item_touch_helper_previous_elevation);
        if (support == null) {
