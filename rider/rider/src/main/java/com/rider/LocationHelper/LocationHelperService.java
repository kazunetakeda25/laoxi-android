...
public class LocationHelperService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public static double dblLatitude,dblLongitude;
    ...
    public void isNewLocationAvailable(Location location) {
        if (location != null) {
            ...
            DataToPref.setSharedPreferanceData(getApplicationContext(), LaoxiConstant.USER_DEFAULT_LONGITUDE, LaoxiConstant.USER_DEFAULT_LONGITUDE_DATA, String.valueOf(dblLongitude));
            DataToPref.setSharedPreferanceData(getApplicationContext(), LaoxiConstant.USER_DEFAULT_LATITUDE, LaoxiConstant.USER_DEFAULT_LATITUDE_DATA, String.valueOf(dblLatitude));
